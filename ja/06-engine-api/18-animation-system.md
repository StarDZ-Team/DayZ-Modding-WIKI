# 第 6.18: Animation System

[Home](../../README.md) | [<< 前: Construction System](17-construction-system.md) | **Animation System**
...
All player actions (eating, bandaging, crafting, emotes) use animation callbacks. `HumanCommandActionCallback` (scripts/3_game/human.c) is the 基底クラス:
...
| `STATE_LOOP_ACTION` | 6 | アクション within loop |
