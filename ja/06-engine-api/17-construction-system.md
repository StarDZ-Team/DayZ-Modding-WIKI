# 第 6.17: Construction System

[Home](../../README.md) | [<< 前: Crafting System](16-crafting-system.md) | **Construction System**
...
- `4_World/entities/itembase/basebuildingbase.c` --- the entity 基底クラス
...
1. **Part IDs 一意でなければなりません** within an object (1-93 range). Gaps are allowed but waste capacity.
