# Глава 8.5: Использование шаблона мода DayZ

> **Краткое содержание:** Этот учебник показывает, как использовать открытый шаблон мода DayZ от InclementDab для быстрого создания нового проекта мода. Вместо того чтобы создавать каждый файл с нуля, вы клонируете готовый каркас, который уже содержит правильную структуру папок, config.cpp, mod.cpp и заглушки скриптовых слоёв. Достаточно переименовать несколько вещей, и можно сразу приступать к написанию кода.
