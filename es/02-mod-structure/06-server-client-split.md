# Capitulo 2.6: Arquitectura Servidor vs Cliente
...
**Ejemplo:** The StarDZ AI Server mod uses `type = "servermod"` because clients should never see the AI brain, perception, combat, or spawning logic:
