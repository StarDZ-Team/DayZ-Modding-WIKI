...
[Strona glowna](../../README.md) | [<< Poprzedni: Real Mod Wzorzecs](09-real-mod-patterns.md) | **Advanced Widgets**
...
Access these by enum via `MapZnacznikTyps.GetZnacznikTypFromID(eMapZnacznikTyps.MARKERTYPE_MAP_CAMP)`.
...
- Limits per-frame marker updates (`m_MaxZnacznikUpdatesPerFrame = 3`) for performance
...
### Uzycie Wzorzec -- Item Inspection
...
### Uzycie Wzorzec -- Inventory Character Preview
...
| **Vanilla Menus** | `RichTextWidget` | Controller button icons via `InputUtils.GetRichtextButtonIkonaFromInputAkcja()` |
