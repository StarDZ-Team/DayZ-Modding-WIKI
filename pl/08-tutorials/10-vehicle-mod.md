...
> **Podsumowanie:** This tutorial walks you through creating a custom vehicle variant in DayZ by extending an existing vanilla vehicle. You will define the vehicle in config.cpp, customize its stats and textures, write script behavior for doors and engine, add it to the server spawn table with pre-attached parts, and test it in-game. By the end, you will have a fully drivable custom Offroad Hatchback variant with modified performance and appearance.
...
**GetAnimInstance** -- Zwraca which animation set the player uses when sitting in the vehicle. The enum values are:

| Wartosc | Stala | Vehicle Typ |
|-------|----------|-------------|
| 0 | `CIVVAN` | Van |
| 1 | `V3S` | V3S Truck |
| 2 | `SEDAN` | Olga Sedan |
...
**Nastepny:** Expand your vehicle mod with custom door models, interior textures, or even a completely new vehicle body using Blender and Object Builder.
...
**Poprzedni:** [Chapter 8.9: Professional Mod Template](09-professional-template.md)
