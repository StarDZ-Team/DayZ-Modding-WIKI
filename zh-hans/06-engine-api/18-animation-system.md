...
[Home](../../README.md) | [<< 上一章: Construction System](17-construction-system.md) | **Animation System**
...
All player actions (eating, bandaging, crafting, emotes) use animation callbacks. `HumanCommandActionCallback` (scripts/3_game/human.c) is the 基类:
...
| `STATE_LOOP_ACTION` | 6 | 操作 within loop |
