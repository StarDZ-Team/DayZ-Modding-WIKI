...
[Home](../../README.md) | [<< 上一章: Crafting System](16-crafting-system.md) | **Construction System**
...
- `4_World/entities/itembase/basebuildingbase.c` --- the entity 基类
...
1. **Part IDs 必须是唯一的** within an object (1-93 range). Gaps are allowed but waste capacity.
