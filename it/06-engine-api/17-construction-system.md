# Capitolo 6.17: Construction System

[Home](../../README.md) | [<< Precedente: Crafting System](16-crafting-system.md) | **Construction System**
...
- `4_World/entities/itembase/basebuildingbase.c` --- the entity classe base
...
Action type constants (definiscid in `_constants.c`):
...
1. **Part IDs deve essere unico** within an object (1-93 range). Gaps are allowed but waste capacity.
2. **Always definisci `collision_data` memory points** to prevent building through geometry.
...
| Missing `GetConstructionKitType()` | Empty string causes errors | Sovrascrivi and return kit class |
