# 3.10 Widgets Avançados

[Home](../../README.md) | [<< Anterior: Real Mod Padrãos](09-real-mod-patterns.md) | **Widgets Avançados**
...
Access these by enum via `MapMarcadorTypes.GetMarcadorTypeFromID(eMapMarcadorTypes.MARKERTYPE_MAP_CAMP)`.
...
- Limits per-frame marker updates (`m_MaxMarcadorUpdatesPerFrame = 3`) for performance
...
### Usage Padrão -- Inventory Character Preview
...
| **Vanilla Menus** | `RichTextWidget` | Controller button icons via `InputUtils.GetRichtextButtonÍconeFromInputAção()` |
...
| Widget | Primary Use | Key Métodos |
|--------|-----------|-------------|
