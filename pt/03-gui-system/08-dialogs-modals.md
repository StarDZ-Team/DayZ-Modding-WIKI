# 3.8 Diálogos e Modais

[Home](../../README.md) | [<< Anterior: Styles & Fonts](07-styles-fonts.md) | **Diálogos e Modais**
...
- **Modal** -- Blocks all interaction with content behind the dialog. The user must respond (confirm, cancel, close) before doing anything else. Exemplos: quit confirmation, delete warning, rename prompt.
- **Modeless** -- Allows the user to interact with content behind the dialog while it remains open. Exemplos: info panels, settings windows, tool palettes.
...
### Key Lifecycle Métodos

| Método | Quando Chamado | Uso Típico |
|--------|------------|-------------|
...
## Manual Dialog Padrão (Without UIScriptedMenu)
...
### VPP-Style Popup (OnWidgetScriptInit Padrão)
...
|----------|-----------|-----------------|----------|
| Engine menu stack | `UIScriptedMenu` | Automatic via `LockControla`/`UnlockControla` | Full-screen menus, major dialogs |
