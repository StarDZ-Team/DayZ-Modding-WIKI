# Capítulo 4.8: Modelagem de Edifícios -- Portas e Escadas

[<< Anterior: Guia do Workbench](07-workbench-guide.md) | **Modelagem de Edifícios**
...
- Familiarity with the LOD system and named selections (covered in [Capítulo 4.2: 3D Models](02-models.md)).
...
- [Model Requirements Resumo](#model-requirements-summary)
...
2. **Memory LOD vertices** that define:
   ...
   - **Ação widget position** -- Onde the interaction widget is displayed to the player.
...
| `soundOpen` | Sound class from `CfgAçãoSounds` played when the door opens. See `DZ\sounds\hpp\config.cpp` for available sound sets. |
...
- [Capítulo 4.2: 3D Models](02-models.md) -- LOD system, named selections, `model.cfg` fundamentals
...
| Anterior | Up | Próximo |
|----------|----|------|
| [4.7 Guia do Workbench](07-workbench-guide.md) | [Part 4: File Formats & DayZ Tools](01-textures.md) | -- |
