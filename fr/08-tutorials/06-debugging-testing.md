# Chapitre 8.6 : Debogage et Test de Votre Mod

> **Resume :** Ce tutoriel vous apprend a deboguer et tester les mods DayZ efficacement. You will learn to read script logs, use Print debugging, work with DayZDiag and file patching for rapid iteration, diagnose common error messages, and establish a reliable testing workflow. No IDE debugger exists for retail builds -- your tools are script logs, Print statements, Workbench, DayZDiag, and file patching.
...
| Fonctionnalite | Retail DayZ | DayZDiag |
|---------|-------------|----------|
...
| Type de Fichier | File Patching Works? |
|-----------|---------------------|
| Script files (`.c`) | Yes |
